    ...
    <nav className="searchbar-nav">
      ...
      <div>
        <select 
          id="region" 
          ref={refRegion}
          onChange={(evento) => evento.target.value !== 'default' && onRegionChange(evento, dispatch)}
        > 
        ...
        <select 
          id="activity" 
          ref={refActivity}
          onChange={(evento) => evento.target.value !== 'default' && onActivityChange(evento, dispatch)}
        >
        ...
        <select 
          id="alphabet" 
          ref={refAz}
          onChange={(evento) => evento.target.value !== 'default' && onAzChange(evento, dispatch)}
        >
        ...
        <select 
          id="population"
          ref={refPopulation}
          onChange={(evento) => evento.target.value !== 'default' && onPopulationChange(evento, dispatch)}
        >
          <option value="default">Sort by</option>
      ...
      <div className="searchbar-input-cotainer">
        <input 
          ...
          id="search"
          ref={refInput}
          onChange={(evento) => evento.target.value !== '' && onInputChange(evento.target.value, setInput)}
        />
        <button 
